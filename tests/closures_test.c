...
int main(void) {
  ...
  r = lizard_test_eval(&e, "(define (make-counter)"
                           "  (define n 0)"
                           "  (lambda ()"
                           "    (set! n (+ n 1))"
                           "    n))"
  ...
  r = lizard_test_eval(&e, "(define (compose f g) (lambda (x) (f (g x))))"
  ...
  r = lizard_test_eval(&e, "(define x 10)"
