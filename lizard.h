...
typedef lizard_ast_node_t *(*lizard_primitive_func_t)(ds_list_t *args,
                                                      lizard_env_t *env,
                                                      lizard_heap_t *heap);
...
struct lizard_ast_node {
  ...
  union {
    ...
    struct {
      ds_list_t *parameters;
      lizard_env_t *closure_env;
    } lambda;
    ds_list_t *begin_expressions;
    ds_list_t *cond_clauses;
    ds_list_t *application_arguments;
    struct {
